...
<!-- template: register.ftl -->
    ...
    <#elseif section = "form">
        <form id="kc-register-form" class="${properties.kcFormClass!}" action="${url.registrationAction}" method="post" novalidate="novalidate">
            ...
            <#else>
                <div id="kc-form-buttons" class="${properties.kcFormButtonsClass!}">
                    <button class="${properties.kcButtonClass!} ${properties.kcButtonPrimaryClass!} ${properties.kcButtonBlockClass!} ${properties.kcButtonLargeClass!} kc-primary-button" type="submit">
                        Create account
                    </button>
                </div>
            </#if>
    ...
    <#elseif section = "footer">
        <div class="kc-footer-links">
            <div class="kc-footer-line">
                <span>Already have an account? <a href="${url.loginUrl}">Log in →</a></span>
            </div>
